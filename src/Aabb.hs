...
aabbToRectangle (Aabb (V2 xmin ymin) (V2 xmax ymax)) = Rectangle (P (V2 xmin ymin)) (V2 (xmax - xmin) (ymax - ymin))

rectangleToAabb :: Rectangle Float -> Aabb
rectangleToAabb (Rectangle (P (V2 x y)) (V2 width height)) = Aabb { pMin = V2 x y
